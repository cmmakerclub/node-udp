...
server.on('message', function (message, remote) { 
  ...
  if (out.makerlab.myName) {
    cmmc.publish("CMMC/nb-makerlab/"+out.makerlab.myName, JSON.stringify(out) );
    odin.publish("ML/nb-makerlab/"+out.makerlab.myName, JSON.stringify(out) );
  }
  else {
    cmmc.publish("CMMC/nb-makerlab/1", JSON.stringify(out) );
    odin.publish("ML/nb-makerlab/1", JSON.stringify(out) );
  }
